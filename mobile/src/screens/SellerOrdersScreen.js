...
const SellerOrdersScreen = ({ navigation }) => {
  ...
  const renderItem = ({ item }) => (
    ...
    >
      ...
      <Text style={styles.customerText}>Customer: {item.customer?.fullName || 'Unknown'}</Text>
...
const styles = StyleSheet.create({
  ...
  customerText: { fontSize: 14, color: '#444', marginBottom: 4, fontWeight: '600' },
  dateText: { fontSize: 13, color: '#666', marginBottom: 12 },
  itemsSummary: { backgroundColor: '#f8f8f8', padding: 10, borderRadius: 8 },
