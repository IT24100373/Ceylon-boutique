        ...
        <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.card}>
            <TouchableOpacity style={styles.uploadBox} onPress={pickImage}>
              ...
              <Text style={styles.uploadBoxText}>Add More Photos</Text>
            </TouchableOpacity>
          ...
          <View style={styles.hintCard}>
            <Icon name="info" size={18} color="#8A8178" style={{ marginRight: 12 }} />
            <Text style={styles.hintText}>To update stock quantities, please use the "Inventory" section on the main dashboard.</Text>
          </View>
          ...
          <TouchableOpacity
            ...
            disabled={loading}
          >
            {loading ? <ActivityIndicator color="#FFFFFF" /> : <Text style={styles.submitBtnText}>Save Changes</Text>}
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  loadingText: { marginTop: 15, fontSize: 14, fontFamily: 'Montserrat_400Regular', color: '#8A8178' },
  ...
  uploadBox: {
    height: 120, backgroundColor: '#F8F6F4', borderRadius: 20, borderStyle: 'dashed', borderWidth: 2, borderColor: '#EEEADD',
  ...
  hintCard: { flexDirection: 'row', backgroundColor: '#F8F6F4', padding: 16, borderRadius: 16, marginVertical: 10, borderWidth: 1, borderColor: '#EEEADD' },
  hintText: { flex: 1, fontSize: 13, fontFamily: 'Montserrat_400Regular', color: '#8A8178', lineHeight: 20 },
